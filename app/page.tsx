          ...
          <div className="modal-box">
            ...
            <div>
              <input
                ...
                className="border border-base-300 input input-bordered w-fullmb-4 placeholder:text-sm"
                required
              />
...
function createProject(name: string, description: string, email: string) {
